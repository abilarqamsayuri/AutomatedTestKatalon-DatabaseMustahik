...
WebUI.setText(findTestObject('Object Repository/Page_PeTIK MUSTAHIK/input_PeTIK MUSTAHIK_LoginFormusername'), 'testerjatim@ybmpln.org')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_PeTIK MUSTAHIK/input_PeTIK MUSTAHIK_LoginFormpassword'), '4qXQM5zcwHRG/g2yfqFsXA==')
...
WebUI.clickOffset(findTestObject('Object Repository/Page_Mustahik/td_08950793XXXX'), 0, 0)
